...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("VidSuch.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.lbl_ergebnis.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lbl_ergebnis.setStyleSheet("")
        self.lbl_ergebnis.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.lst_erg.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.lst_erg.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lst_erg.setAutoFillBackground(True)
        self.lst_erg.setStyleSheet("")
        self.lst_erg.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.lst_erg.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.lst_erg.setAutoScrollMargin(16)
        self.lst_erg.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.DoubleClicked|QtWidgets.QAbstractItemView.EditTrigger.EditKeyPressed)
        self.lst_erg.setAlternatingRowColors(True)
        self.lst_erg.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.NoSelection)
        self.lst_erg.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectItems)
        self.lst_erg.setTextElideMode(QtCore.Qt.TextElideMode.ElideRight)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.btnLeer)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.le_such1)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.btnLeer2)
        self.le_such2 = QtWidgets.QLineEdit(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.le_such2.setFont(font)
        self.le_such2.setObjectName("le_such2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.le_such2)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.proBar)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.btn_suchen)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("EndBut_neutral.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap("EndBut_focus.png"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        icon1.addPixmap(QtGui.QPixmap("EndBut_pushed.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.On)
        ...
        self.lbl_db.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.lbl_db.setAutoFillBackground(False)
        self.lbl_db.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhNoAutoUppercase)
        self.lbl_db.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.actionEnde = QtGui.QAction(MainWindow)
        self.actionEnde.setObjectName("actionEnde")
        self.actionEinfuegen = QtGui.QAction(MainWindow)
